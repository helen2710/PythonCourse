...
# CODUL TĂU VINE MAI JOS:
print("My friend2 is", str(int(age2) - age),"years older than me")
print("My friend3 is", str(age - int(age3)),"years younger than me")
# CODUL TĂU VINE MAI SUS:
...
# CODUL TĂU VINE MAI JOS:
print(age2/float(age)) 
print(float(age)/age3)
print(age2/float(age)/age3) # împărțirea vârstelor trei prieteni
# CODUL TĂU VINE MAI SUS:
