...
# CODUL TĂU VINE MAI JOS:
numbers_set.remove(3) # or   numbers_set.discard(3)
print(numbers_set)
# CODUL TĂU VINE MAI SUS:
...
# CODUL TĂU VINE MAI JOS:
print(numbers_set.intersection({4, 5, 6, 7}))  # or common_elements = numbers_set & {4, 5, 6, 7}
# CODUL TĂU VINE MAI SUS:

# Verificați elementele diferite din setul `numbers_set` și setul {4, 5, 6, 7}

# CODUL TĂU VINE MAI JOS:
print(numbers_set.difference({4, 5, 6, 7})) # or print(numbers_set ^ {4, 5, 6, 7})
# CODUL TĂU VINE MAI SUS:
...
# CODUL TĂU VINE MAI JOS:
print(numbers_set) # expect error
# CODUL TĂU VINE MAI SUS:
