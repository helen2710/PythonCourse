...
class Telefon(Produs):
    def __init__(self, numele, pretul, anul_producerii, batery, memory):
        super().__init__(numele, pretul, anul_producerii)
        self.baterie_mAh = batery 
        self.memorie_GB = memory
...
# CODUL TĂU VINE MAI JOS:
class Laptop(Produs):
    def __init__(self, numele, pretul, anul_producerii, os, procesor):
        super().__init__(numele, pretul, anul_producerii)
        self.sistem_de_operare = os
...
class Trotineta(Produs):
    def __init__(self, numele, pretul, anul_producerii, speed_max, automat):
        super().__init__(numele, pretul, anul_producerii)
        self.viteza_maxima = speed_max
        self.autonomie_km = automat
